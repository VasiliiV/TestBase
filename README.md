...
<br/> 1 способ. Для старта запускаем скрипт first-start.sh через терминал ./first-start.sh. 
<br/> Если нет npm, то скачать тут: https://nodejs.org/en Выбрать рекомендованные.
<br/> 2 способ. Осуществить запуск:
<br/> Удалите папку node_modules в папке my-app, после ввести там же npm i в терминале
<br/> cd ./my-app
<br/> npm run dev
